...
import { Check, Trash2, User, Calendar, ExternalLink, Pencil, X, MoreVertical } from "lucide-react";
                    ...
                    <h4
                        ...
                        className={cn(
                            ...
                            item.isCompleted
                                ...
                                : isOverdue
                                    ? "text-red-600 hover:text-red-700 cursor-pointer transition-colors"
